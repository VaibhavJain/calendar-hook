...
<%@page import="com.liferay.hook.calendar.model.CalEventAttendee"%>
<%@page import="com.liferay.hook.calendar.service.CalEventAttendeeLocalServiceUtil"%>
...
<style type="text/css">
			...
			.cross {
				...
				width: 16px;
				height: 16px;
				background: no-repeat url(/html/portlet/calendar/img/cross.gif) -4px 0;
				opacity: 0.3;
				vertical-align: top;
				cursor: pointer;				
				float: right;
			...
			#userAutocomplete .aui-toolbar-content {
				margin-top: 10px;
			}
			
			#userAutocomplete .aui-field-input-text {
				width: 190px
			}
</style>
